...
public class HomePage {
    ...
    public static final By ALL_SEARCH_RESULTS_TITLE = By.xpath("//div[@class = 'products']/div[1]//p[@class= 'products__name']");
    public static final By FIRST_SEARCHED_PRODUCT_TITLE = By.xpath("//div[@class = 'products']/div//p[@class= 'products__name']");
